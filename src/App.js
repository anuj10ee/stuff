...
function App() {
  ...
  const fetchEmployeeList = async (currentPage) => {
    ...
    // const total=apiResponse.headers.get('x-total-count');
    // console.log("a");
    // console.log(total);
  ...
  const deleteEmployee = async (id) => {
    // let apiResponse=await axios.delete(`https://mockrestapi.herokuapp.com/api/employee/${id}`);
    // getData(apiResponse.data.data);
  ...
  //     `https://mockrestapi.herokuapp.com/api/employee?pageNo=${currentPage}&limit=25`
  //   );
